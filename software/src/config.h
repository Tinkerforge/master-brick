...
#define BRICK_HARDWARE_VERSION_MAJOR_30 3
#define BRICK_HARDWARE_VERSION_MINOR_30 0
#define BRICK_HARDWARE_VERSION_REVISION_30 0
...
#define PIN_MASTER30_DETECT {1 << 14, PIOC, ID_PIOC, PIO_INPUT, PIO_PULLUP}
...
#define BRICKLET_D_PIN_1_AD_30 {1 << 7, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define BRICKLET_D_PIN_2_DA    {1 << 14, PIOB, ID_PIOB, PIO_INPUT, PIO_DEFAULT}
#define BRICKLET_D_PIN_2_DA_30 {1 << 4, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
...
#define PIN_BRICKLET_ENABLE {1 << 8, PIOC, ID_PIOC, PIO_OUTPUT_1, PIO_DEFAULT}

// ************** EXTENSION SETTINGS **************
#define PIN_EXT_0_SELECT    {1 << 28, PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define PIN_EXT_0_SELECT_30 {1 << 29, PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
...
#define PIN_EXT_0_GP_2_30   {1 << 8, PIOC, ID_PIOC, PIO_INPUT, PIO_DEFAULT}

#define PIN_EXT_1_SELECT    {1 << 29, PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define PIN_EXT_1_SELECT_30 {1 << 28, PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define PIN_EXT_1_GP_0      {1 << 1, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_1_GP_0_30   {1 << 30, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_1_GP_1      {1 << 30, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_1_GP_1_30   {1 << 3, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_1_GP_2      {1 << 31, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_1_GP_2_30   {1 << 27, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
...
#define PINS_EXT_21       PIN_EXT_0_GP_0_21, PIN_EXT_0_GP_1, PIN_EXT_0_GP_2, \
                          PIN_EXT_1_GP_0, PIN_EXT_1_GP_1, PIN_EXT_1_GP_2
#define PINS_EXT_30       PIN_EXT_0_GP_0_21, PIN_EXT_0_GP_1, PIN_EXT_0_GP_2_30, \
                          PIN_EXT_1_GP_0_30, PIN_EXT_1_GP_1_30, PIN_EXT_1_GP_2_30
