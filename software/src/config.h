...
#define BRICK_FIRMWARE_VERSION_MINOR 5
#define BRICK_FIRMWARE_VERSION_REVISION 2

#define BRICK_HARDWARE_VERSION_MAJOR_32 3
#define BRICK_HARDWARE_VERSION_MINOR_32 2
#define BRICK_HARDWARE_VERSION_REVISION_32 0

#define BRICK_HARDWARE_VERSION_MAJOR_31 3
#define BRICK_HARDWARE_VERSION_MINOR_31 1
#define BRICK_HARDWARE_VERSION_REVISION_31 0

#define BRICK_HARDWARE_VERSION_MAJOR_21 2
#define BRICK_HARDWARE_VERSION_MINOR_21 1
#define BRICK_HARDWARE_VERSION_REVISION_21 0
...
#define PIN_SCL_PULLUP_MASTER   {1 << 0, PIOA, ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}
#define PIN_SDA_PULLUP_MASTER   {1 << 17, PIOC, ID_PIOC, PIO_OUTPUT_1, PIO_DEFAULT}
#define PINS_TWI_PULLUP_MASTER  PIN_SCL_PULLUP_MASTER, PIN_SDA_PULLUP_MASTER

#define PIN_SCL_PULLUP_SLAVE    {1 << 0, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_SDA_PULLUP_SLAVE    {1 << 17, PIOC, ID_PIOC, PIO_INPUT, PIO_DEFAULT}
...
#define PIN_MASTER21_DETECT {1 << 16, PIOC, ID_PIOC, PIO_INPUT, PIO_PULLUP}
#define PIN_MASTER31_DETECT {1 << 14, PIOC, ID_PIOC, PIO_INPUT, PIO_PULLUP}
#define PIN_MASTER32_DETECT {1 << 23, PIOA, ID_PIOA, PIO_INPUT, PIO_PULLUP}
...
#define BRICKLET_D_PIN_1_AD_31 {1 << 7, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define BRICKLET_D_PIN_2_DA    {1 << 14, PIOB, ID_PIOB, PIO_INPUT, PIO_DEFAULT}
#define BRICKLET_D_PIN_2_DA_31 {1 << 4, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
...
// Available since HW version 3.0
#define PIN_BRICKLET_ENABLE {1 << 1, PIOA, ID_PIOA, PIO_OUTPUT_1, PIO_DEFAULT}

// ************** EXTENSION SETTINGS **************
#define PIN_EXT_0_SELECT    {1 << 28, PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define PIN_EXT_0_SELECT_31 {1 << 29, PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define PIN_EXT_0_GP_0_10   {1 << 9, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_0_GP_0_21   {1 << 8, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_0_GP_0_31   {1 << 10, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_0_GP_1      {1 << 10, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_0_GP_1_31   {1 << 8, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_0_GP_2      {1 << 27, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_0_GP_2_31   {1 << 8, PIOC, ID_PIOC, PIO_INPUT, PIO_DEFAULT}

#define PIN_EXT_1_SELECT    {1 << 29, PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define PIN_EXT_1_SELECT_31 {1 << 28, PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define PIN_EXT_1_GP_0      {1 << 1, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_1_GP_0_31   {1 << 30, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_1_GP_1      {1 << 30, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_1_GP_1_31   {1 << 3, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_1_GP_2      {1 << 31, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
#define PIN_EXT_1_GP_2_31   {1 << 27, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}

#define PINS_EXT_10       PIN_EXT_0_GP_0_10, PIN_EXT_0_GP_1, PIN_EXT_0_GP_2, \
                          PIN_EXT_1_GP_0, PIN_EXT_1_GP_1, PIN_EXT_1_GP_2
#define PINS_EXT_21       PIN_EXT_0_GP_0_21, PIN_EXT_0_GP_1, PIN_EXT_0_GP_2, \
                          PIN_EXT_1_GP_0, PIN_EXT_1_GP_1, PIN_EXT_1_GP_2
#define PINS_EXT_31       PIN_EXT_0_GP_0_21, PIN_EXT_0_GP_1, PIN_EXT_0_GP_2_31, \
                          PIN_EXT_1_GP_0_31, PIN_EXT_1_GP_1_31, PIN_EXT_1_GP_2_31
