...
#define RS485_MAX_BAUDRATE 2000000
#define RS485_MAX_DATA_LENGTH 80
#define RS485_BUFFER_SIZE RS485_MAX_DATA_LENGTH
#define RS485_MESSAGE_HEADER_SIZE 3
#define RS485_MESSAGE_FOOTER_SIZE 2
#define RS485_MESSAGE_OVERHEAD (RS485_MESSAGE_HEADER_SIZE+RS485_MESSAGE_FOOTER_SIZE)

#define RS485_MESSAGE_MODBUS_ADDRESS 0
#define RS485_MESSAGE_MODBUS_FUNCTION 1
#define RS485_MESSAGE_MODBUS_SEQUENCE_NUMBER 2
#define RS485_MESSAGE_UID 3
#define RS485_MESSAGE_LENGTH 7
#define RS485_MESSGAE_FID 8

#define RS485_LOW_LEVEL_SEND_TRIES_MAX 3
