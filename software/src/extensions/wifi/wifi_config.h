...
#define WIFI_AUTHENTICATION_SECRET_KEY_POS (WIFI_HOSTNAME_POS + sizeof(WIFIHostname))
#define WIFI_AUTHENTICATION_SECRET_POS (4 + WIFI_AUTHENTICATION_SECRET_KEY_POS)
