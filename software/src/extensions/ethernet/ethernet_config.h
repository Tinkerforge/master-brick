...
#define ETHERNET_W5200_READ_COMMAND    0x00
#define ETHERNET_W5200_WRITE_COMMAND   0x80
#define ETHERNET_W5500_READ_COMMAND    0x00
#define ETHERNET_W5500_WRITE_COMMAND   0x04
